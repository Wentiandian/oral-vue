  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">
          <img src="~@/assets/img/logo/home-logo.jpg" style="width: 120px;height: 65px"/>
        </a>
        <a class="site-navbar__brand-mini" href="javascript:;">
          <img src="~@/assets/img/logo/home-logo-mini.jpg" style="width: 40px;height: 30px"/>
        </a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      <el-menu
        ...
        <h2 class="site-navbar__font" style="width: 300px;margin-top:5px;font-size: 30px;color: #545457;font-family: 幼圆">
          口腔医院管理平台
        </h2>
      </el-menu>
      <el-menu
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom">
            <span class="el-dropdown-link">
              <img src="~@/assets/img/avatar/avatar7.png" :alt="userName">{{ userName }}
            </span>
